...
var ActivitylogService = /** @class */ (function () {
    ...
    ActivitylogService.prototype.list = function () {
        return this.httpService.get("logs/").then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
    ActivitylogService.prototype.search = function (filter) {
        return this.httpService.get("logs/", { entity: filter.entity, entityID: filter.entityID, action: filter.action }).then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
...
var AppointmentService = /** @class */ (function () {
    ...
    AppointmentService.prototype.list = function () {
        return this.httpService.get("appointment/").then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
    AppointmentService.prototype.get = function (appointmentId) {
        return this.httpService.get("appointment/" + appointmentId, { id: appointmentId }).then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
    AppointmentService.prototype.save = function (appointment) {
        ...
        return this.httpService.post(url, appointment).then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
    AppointmentService.prototype.delete = function (appointmentId) {
        ...
        return this.httpService.delete("appointment/" + appointmentId).then(function (resp) {
            return {};
        });
    };
...
var AuthService = /** @class */ (function () {
        ...
        this.amplifyService.authStateChange$.subscribe(function (authState) {
            if (authState.state == 'signedIn') {
                ...
                if (!_this._inAuthentication) {
                    ...
                    _this.http.post('user/login', syncUserData)
    ...
    AuthService.prototype.signOut = function () {
        this._isLoggedIn = false;
        this._user = null;
        var systemSignout = this.http.post('user/logout');
        // @see https://aws-amplify.github.io/docs/js/authentication
...
var ClientService = /** @class */ (function () {
    ...
    ClientService.prototype.list = function () {
        return this.httpService.get("client/").then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
    ClientService.prototype.get = function (clientId) {
        return this.httpService.get("client/" + clientId, { id: clientId }).then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.get = function (path, data) {
        ...
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ params: data, withCredentials: true });
...
var TherapistService = /** @class */ (function () {
    ...
    TherapistService.prototype.list = function () {
        return this.httpService.get(this.PATH).then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
    TherapistService.prototype.get = function (therapistId) {
        return this.httpService.get(this.PATH + therapistId, { id: therapistId }).then(function (resp) {
            var data = resp.json();
            return data;
        });
    };
